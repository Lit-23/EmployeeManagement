          ...
          <div>
            ...
            <ul>
              <Link to='/employee-login'>
                <li className="hover:underline text-gray-400 cursor-pointer max-[640px]:text-xs">Employee Login</li>
              </Link>
              <Link to='/admin-login'>
                <li className="hover:underline text-gray-400 cursor-pointer max-[640px]:text-xs">Admin Login</li>
              </Link>
            </ul>
          </div>
